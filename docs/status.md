...
`heartbeat` is the only enabled skill and it is running now; its own entry is self-referential and never counts toward its own verdict.
...
|-------|----------|--------|-------------:|---------------------:|
| heartbeat | 2026-07-19 07:53 UTC | ⏳ dispatched | 20% | 2 |
